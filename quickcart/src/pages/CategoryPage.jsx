...
import {
  ArrowLeftIcon, MagnifyingGlassIcon, MixerHorizontalIcon,
  ChevronDownIcon, FileTextIcon, RocketIcon, RowsIcon, DashboardIcon,
...
import {
  CAT_RULES, PLP_RAIL, SUBCATS, BRAND_KEYS, MERCH_ROWS, SORT_OPTIONS,
  DEFAULT_F, applyF, fBadges, fSummary,
} from '../lib/catalog.js'
...
export default function CategoryPage({ onChange, cart, homeBrand = 'ALL', recoStrip, onRecoClose }) {
  ...
  const onPick = (label) => navigate(`/category/${encodeURIComponent(label)}`)
