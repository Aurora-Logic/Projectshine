/* Shared catalog + filter system — category rules, subcategories, merchandising
   shelves and the brand/material/load/size/deals/sort filter helpers.
   Extracted from App.jsx so pages (Home, PLP, Search) and the layout can share them. */

import { CATEGORIES, FEED_POOL } from '../data.js'
