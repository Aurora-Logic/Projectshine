...
export const BUY_AGAIN = [
  { id: 'ba1', stock: 240, brand: 'ebco', ph: '1595428774223-ef52624120d2', name: 'Ebco Telescopic Drawer Slide 450mm (pair)', qty: 'Zinc · 35 kg load', price: 385, usual: true, bulk: '10+ @ ₹350/pc' },
  { id: 'ba2', stock: 8, brand: 'ebco', ph: '1594026112284-02bb6f3352fe', name: 'Ebco Soft-Close Hinge (2 pc)', qty: '0°–110° · clip-on', price: 290, mrp: 310, tag: '7% OFF', usual: true, bulk: '20+ @ ₹265/set' },
  { id: 'ba3', stock: 520, brand: 'ebco', ph: '1582139329536-e7284fece509', name: 'Ebco Cam Lock 19mm', qty: 'Nickel · 2 keys', price: 95, bulk: '50+ @ ₹78/pc' },
  { id: 'ba4', stock: 64, brand: 'ebco', ph: '1558997519-83ea9252edf8', name: 'SS D-Handle 160mm (2 pc)', qty: 'Brushed steel', price: 240 },
  { id: 'ba5', stock: 800, brand: 'ebco', ph: '1556911220-bff31c812dba', name: 'Shelf Support Pins (20 pc)', qty: '5mm · nickel', price: 60 },
]

export const NEW_EBCO = [
  { id: 'ne1', stock: 36, brand: 'ebco', ph: '1556911220-bff31c812dba', name: 'Ebco Quadro Drawer System', qty: '450mm · soft-close', price: 1450, buys: '900+ fitted this month' },
  { id: 'ne2', stock: 90, brand: 'ebco', ph: '1489171078254-c3365d6e359f', name: 'Glass Door Hinge (pair)', qty: '5mm glass · clamp', price: 310, rating: 4.4 },
  { id: 'ne3', stock: 14, brand: 'ebco', ph: '1558997519-83ea9252edf8', name: 'Wardrobe Sliding System 2.4m', qty: '2-door · top hung', price: 3250, mrp: 3990, tag: '19% OFF' },
  { id: 'ne4', stock: 48, brand: 'ebco', ph: '1556228453-efd6c1ff04f6', name: 'Tandem Box Deep Drawer', qty: '500mm · grey', price: 2120, rating: 4.6 },
  { id: 'ne5', stock: 0, lead: 7, brand: 'ebco', ph: '1484154218962-a197022b5858', name: 'Corner Carousel Unit', qty: '270° · 2 shelves', price: 4850, mrp: 5840, tag: '17% OFF' },
  { id: 'ne6', stock: 120, brand: 'ebco', ph: '1595428774223-ef52624120d2', name: 'Aldrop & Tower Bolt Set', qty: 'Matt black · 200mm', price: 420, buys: '500+ fitted this month' },
]

export const DEALS = [
  { id: 'dl1', stock: 6, brand: 'ebco', ph: '1484154218962-a197022b5858', name: 'Ball-Bearing Slide 500mm (pair)', qty: '45 kg load · zinc', price: 520, mrp: 745, tag: '30% OFF', buys: '2k+ fitted this month', bulk: '10+ @ ₹479/pc' },
  { id: 'dl2', stock: 75, brand: 'ebco', ph: '1594026112284-02bb6f3352fe', name: 'Soft-Close Hinge Pack (10 pc)', qty: 'Clip-on · 110°', price: 1260, mrp: 1750, tag: '28% OFF', bulk: '5+ @ ₹1,150/pack' },
  { id: 'dl3', stock: 22, brand: 'livsmart', ph: '1558002038-1055907df827', name: 'Livsmart Digital Furniture Lock', qty: 'RFID + PIN', price: 2399, mrp: 2999, tag: '20% OFF', rating: 4.2 },
  { id: 'dl4', stock: 40, brand: 'worksmart', ph: '1416339306562-f3d12fefd36f', name: 'Worksmart Keyboard Tray', qty: 'Soft-pad · sliding', price: 1899, mrp: 2374, tag: '20% OFF' },
  { id: 'dl5', stock: 55, brand: 'livsmart', ph: '1565814329452-e1efa11c5b89', name: 'Aluminium Profile Light 2m', qty: 'Warm white · 12V', price: 949, mrp: 1116, tag: '15% OFF' },
]

export const WORKSMART = [
  { id: 'ws1', stock: 30, brand: 'worksmart', ph: '1416339306562-f3d12fefd36f', name: 'Keyboard Platform Soft-Pad', qty: 'Slide + tilt', price: 1899, rating: 4.5, bulk: '5+ @ ₹1,750/pc' },
  { id: 'ws2', stock: 85, brand: 'worksmart', ph: '1497366216548-37526070297c', name: 'CPU Trolley with Castors', qty: 'Adjustable width', price: 980, mrp: 1140, tag: '14% OFF' },
  { id: 'ws3', stock: 0, lead: 4, brand: 'worksmart', ph: '1497366811353-6870744d04b2', name: 'Monitor Arm — Single', qty: 'Gas spring · 27"', price: 2450, buys: '300+ fitted this month' },
  { id: 'ws4', stock: 300, brand: 'worksmart', ph: '1581092160562-40aa08e78837', name: 'Desk Grommet 60mm (2 pc)', qty: 'ABS · black', price: 140, rating: 4.7 },
  { id: 'ws5', stock: 150, brand: 'worksmart', ph: '1524758631624-e2822e304c36', name: 'Cable Manager Spine', qty: 'Floor to desk', price: 560 },
]

export const LIVESMART = [
  { id: 'ls1', stock: 95, brand: 'livsmart', ph: '1565814329452-e1efa11c5b89', name: 'LED Strip Light 5m', qty: '2700K · dimmable', price: 850, mrp: 1000, tag: '15% OFF', bulk: '5+ @ ₹790/pc' },
  { id: 'ls2', stock: 9, brand: 'livsmart', ph: '1595428774223-ef52624120d2', name: 'Sensor Cabinet Light', qty: 'Rechargeable · IR', price: 1150, mrp: 1438, tag: '20% OFF', buys: '1k+ fitted this month' },
  { id: 'ls3', stock: 18, brand: 'livsmart', ph: '1558002038-1055907df827', name: 'Smart Digital Door Lock', qty: 'Fingerprint + app', price: 6499, rating: 4.3 },
  { id: 'ls4', stock: 200, brand: 'livsmart', ph: '1582582621959-48d27397dc69', name: 'Motion Night Light', qty: 'USB-C · warm', price: 499, rating: 4.1 },
  { id: 'ls5', stock: 70, brand: 'livsmart', ph: '1586023492125-27b2c045efd7', name: 'Aluminium Profile Kit 1m', qty: 'Recessed · diffused', price: 620, mrp: 745, tag: '17% OFF' },
]

export const ZIPCO_PEKO = [
  { id: 'zp1', stock: 44, brand: 'zipco', ph: '1594026112284-02bb6f3352fe', name: 'Zipco Heavy-Duty Slide 600mm', qty: '60 kg load', price: 680, mrp: 820, tag: '17% OFF', bulk: '10+ @ ₹610/pc' },
  { id: 'zp2', stock: 380, brand: 'peka', ph: '1586023492125-27b2c045efd7', name: 'Peka Concealed Hinge (pair)', qty: '90° · screw-on', price: 180, buys: '700+ fitted this month' },
  { id: 'zp3', stock: 0, lead: 5, brand: 'zipco', ph: '1558997519-83ea9252edf8', name: 'Zipco Wardrobe Lock', qty: 'Left/right · 2 keys', price: 260, mrp: 295, tag: '12% OFF' },
  { id: 'zp4', stock: 160, brand: 'peka', ph: '1551298370-9d3d53740c72', name: 'Peka Magnetic Catch (10 pc)', qty: 'White · 4 kg pull', price: 240, rating: 4.4 },
]

export const FEED_POOL = [
  ...NEW_EBCO, ...DEALS, ...WORKSMART, ...LIVESMART, ...ZIPCO_PEKO, ...BUY_AGAIN,
  { id: 'x1', stock: 210, brand: 'ebco', ph: '1551298370-9d3d53740c72', name: 'Castor Wheels 50mm (4 pc)', qty: 'Twin · brake', price: 320, mrp: 372, tag: '14% OFF' },
  { id: 'x2', stock: 500, brand: 'ebco', ph: '1503387762-592deb58ef4e', name: 'Furniture Connector Kit', qty: 'Minifix · 50 sets', price: 145, buys: '400+ fitted this month' },
]
